  ...
  return (
    <>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogOverlay className="fixed inset-0 bg-black opacity-50" style={{ zIndex: 300 }} />
        <DialogContent className="sm:max-w-[425px] rounded-none border-[#004141] border-[14px] bg-[#ffecc3] p-0" style={{ zIndex: 400 }}>
          <div className="relative">
            ...
            <div className="pt-6 px-6 pb-6">
              <DialogTitle className="text-2xl font-bold mb-4 mt-4">{title}</DialogTitle>
